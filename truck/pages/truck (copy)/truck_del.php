<?php
    ...
    $id = $_GET['id'];
    $sqlemp = "SELECT * FROM user_truck WHERE id='$id'";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel" style="text-align: center;padding-right: 0px">Hapus Data Truck <button type="button" class="close" aria-label="Close" onclick="$('#ModalBatal').modal('hide');"><span>&times;</span></button></h4> 
                    </div>
                ...
                <script type="text/javascript">
                  $(document).ready(function (){
                        $(".save_submit").click(function (e){
                           $.ajax({
                                url: 'pages/truck/truck_del_save.php?id=<?php echo $id;?>',
                                type: 'GET',
